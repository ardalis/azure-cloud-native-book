...
-   In this scenario, the retry operation would have attempted up to 4 retries while doubling the “back-off” duration before formally failing the call.
...
>[Next](azure-platform-resiliency.md) <!-- Next Chapter -->
